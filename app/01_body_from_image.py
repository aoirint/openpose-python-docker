# This is small fix version of https://github.com/CMU-Perceptual-Computing-Lab/openpose/blob/master/examples/tutorial_api_python/01_body_from_image.py
...
OPENPOSE_DIR = '/openpose/build'

# Import Openpose (Windows/Ubuntu/OSX)
dir_path = OPENPOSE_DIR
try:
    # Windows Import
    if platform == "win32":
